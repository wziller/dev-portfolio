...
const SkillTags = (skillsObj) => {
  ...
  const tagGenerator = (skill) => {
    ...
    switch (skill) {
      case "node":
        tag = (
          <div className="tag" id="node-tag">
            <p className="tag-text">Node JS</p>
          </div>
        );
      case "docker":
        tag = (
          <div className="tag" id="docker-tag">
      ...
      case "aws":
        tag = (
          <div className="tag" id="aws-tag">
            <p className="tag-text">AWS</p>
          </div>
        );
      case "api":
        tag = (
          <div className="tag" id="api-tag">
      ...
      case "github":
        tag = (
          <div className="tag" id="github-tag">
      ...
      case "html5":
        tag = (
          <div className="tag" id="html5-tag">
      ...
      case "javascript":
        tag = (
          <div className="tag" id="javascript-tag">
      ...
      case "react":
        tag = (
          <div className="tag" id="react-tag">
      ...
      case "graphql":
        tag = (
          <div className="tag" id="graphql-tag">
      ...
      case "jquery":
        tag = (
          <div className="tag" id="jquery-tag">
      ...
      case "kibana":
        tag = (
          <div className="tag" id="kibana-tag">
      ...
      case "snowflake":
        tag = (
          <div className="tag" id="snowflake-tag">
        ...
        case "google":
        tag = (
          <div className="tag" id="google-tag">
